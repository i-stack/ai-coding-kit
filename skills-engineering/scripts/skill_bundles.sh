#!/usr/bin/env bash
# =============================================================================
# skill_bundles.sh — agentskills.io 兼容的技能打包 / 导入 / 校验
#
...
#
# 用法:
#   bash scripts/skill_bundles.sh export <skill> [--out DIR] [--tar]
#   bash scripts/skill_bundles.sh validate <skill>
#   bash scripts/skill_bundles.sh import <bundle.tar.gz|bundle-dir> [--target DIR] [--name NAME] [--force]
#   bash scripts/skill_bundles.sh list
# =============================================================================
set -euo pipefail

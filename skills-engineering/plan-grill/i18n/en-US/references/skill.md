...
- [PG-004] **Lock output**: After decision tree is parsed and consensus reached with user, produce `PLAN.md` (Goal / Constraints & assumptions / Approach / Key decisions & tradeoffs / Validation plan / Risks / Out of scope). **Do not execute plan before confirmation.**

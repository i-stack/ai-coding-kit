...
bash scripts/test-proposal-scripts.sh
...
if ENV["SKIP_SWIFT_TYPECHECK"] == "1"
  warn "Repository template Swift typecheck skipped (SKIP_SWIFT_TYPECHECK=1)"
elsif system("command -v swiftc >/dev/null 2>&1")

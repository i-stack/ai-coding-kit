...
BEGIN_MARKER = "# BEGIN MCP SYNC (from mcp-servers.json)"
...
def generate_toml(servers: dict) -> str:
    lines = []
    lines.append(f"# AUTOGENERATED from {SRC.name}")
    lines.append("")

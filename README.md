...
[![MCP Config Sync](https://img.shields.io/badge/MCP%20Config-Cursor%20%7C%20CodeBuddy%20%7C%20Codex%20%7C%20Claude%20%7C%20Xcode%20%7C%20Gemini%20%7C%20Continue-663399)](sync/README.md)
...
**ai-coding-kit** is a local AI coding workflow kit for maintaining Agent Skills, syncing MCP configuration, and experimenting with a Universal RAG Gateway. It is built for CodeBuddy, Codex, Claude Code, Cursor, Gemini CLI, Continue, Xcode Coding Assistant, and OpenAI-compatible clients that need shared engineering rules, tool configuration, memory, retrieval, and provider routing.
...
- Developers who want reusable Agent Skills for CodeBuddy, Codex, Claude Code, Cursor, Gemini, or Xcode workflows.
...
- Maintainers who want one source of truth for MCP configuration across multiple AI coding hosts (Cursor, CodeBuddy, Claude, Cline, Gemini, Continue, Xcode).

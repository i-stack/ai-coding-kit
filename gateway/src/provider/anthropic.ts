...
export class AnthropicProvider implements Provider {
     ...
     */
    private toAnthropicParams(messages: NormalizedMessage[]): {
        system?: string;
     ...
     */
    private toAnthropicTools(tools?: NormalizedTool[]): Anthropic.Tool[] | undefined {
     ...
     */
    private toAnthropicToolChoice(tc?: ToolChoice): Anthropic.MessageCreateParams["tool_choice"] {
     ...
     */
    private mapFinishReason(stopReason: string | null | undefined): string | null {
        switch (stopReason) {
            case "end_turn":
            case "stop_sequence":
                return "stop";
     ...
     */
    private extractToolCalls(content: Anthropic.ContentBlock[]): ProviderResult["toolCalls"] {
     ...
     */
    private extractTextContent(content: Anthropic.ContentBlock[]): string | null {

 ...
 *   - mcp_call: deferred to later iteration (returns a placeholder)
 */
      ...
      switch (spec.executor.type) {
        ...
        case "mcp_call":
          return {
            toolCallId,
            name: spec.name,
            content: `[mcp_call] Not yet implemented: ${spec.executor.server}/${spec.executor.method}`,
            success: false,
            error: "MCP call executor not implemented in MVP",
          };
        default:
          return {
            toolCallId,
